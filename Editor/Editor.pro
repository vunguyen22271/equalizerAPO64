...
isEmpty(LIBSNDFILE_INCLUDE) {
	LIBSNDFILE_INCLUDE = "$$PWD/../external-lib/libsndfile/libsndfile-1.2.2-win64/include"
}
LIBSNDFILE_LIB = $$(LIBSNDFILE_LIB)
isEmpty(LIBSNDFILE_LIB) {
	LIBSNDFILE_LIB = "$$PWD/../external-lib/libsndfile/libsndfile-1.2.2-win64/lib"
}

FFTW_INCLUDE = $$(FFTW_INCLUDE)
isEmpty(FFTW_INCLUDE) {
	FFTW_INCLUDE = "$$PWD/../external-lib/fftw"
}

FFTW_LIB = $$(FFTW_LIB)
isEmpty(FFTW_LIB) {
	FFTW_LIB = "$$PWD/../external-lib/fftw"
}
